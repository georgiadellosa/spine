...
const ICONS = {
  ...
  transactions: `<svg viewBox="0 0 64 64" fill="none">
    <rect x="10" y="14" width="44" height="36" rx="4" fill="currentColor" opacity="0.18"/>
    <rect x="10" y="14" width="44" height="36" rx="4" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <path d="M18 26h22M18 34h28M18 42h16" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
    <circle cx="46" cy="26" r="4" fill="currentColor" opacity="0.7"/>
  </svg>`,
  debts: `<svg viewBox="0 0 64 64" fill="none">
    <path d="M32 50C18 50 10 38 10 26c0-9 7-16 16-16 6 0 11 4 11 4s5-4 11-4c9 0 16 7 16 16 0 12-12 24-26 24z" fill="currentColor" opacity="0.18"/>
    <path d="M32 50C18 50 10 38 10 26c0-9 7-16 16-16 6 0 11 4 11 4s5-4 11-4c9 0 16 7 16 16 0 12-12 24-26 24z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round" fill="none"/>
    <path d="M22 24v6a4 4 0 0 0 4 4h12a4 4 0 0 0 4-4v-6" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" fill="none"/>
  </svg>`,
  bills: `<svg viewBox="0 0 64 64" fill="none">
    <path d="M14 56l4-4 4 4 4-4 4 4 4-4 4 4 4-4 4 4 4-4 4 4V8H14z" fill="currentColor" opacity="0.18"/>
    <path d="M14 56l4-4 4 4 4-4 4 4 4-4 4 4 4-4 4 4 4-4 4 4V8H14z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round" fill="none"/>
    ...
    <line x1="22" y1="36" x2="34" y2="36" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
  </svg>`,
  categories: `<svg viewBox="0 0 64 64" fill="none">
    <rect x="8" y="10" width="22" height="18" rx="3" fill="currentColor" opacity="0.18"/>
    <rect x="34" y="10" width="22" height="18" rx="3" fill="currentColor" opacity="0.18"/>
    <rect x="8" y="36" width="22" height="18" rx="3" fill="currentColor" opacity="0.18"/>
    <rect x="34" y="36" width="22" height="18" rx="3" fill="currentColor" opacity="0.18"/>
    <rect x="8" y="10" width="22" height="18" rx="3" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <rect x="34" y="10" width="22" height="18" rx="3" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <rect x="8" y="36" width="22" height="18" rx="3" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <rect x="34" y="36" width="22" height="18" rx="3" stroke="currentColor" stroke-width="2.5" fill="none"/>
  </svg>`,
  accounts: `<svg viewBox="0 0 64 64" fill="none">
    <path d="M10 26l22-12 22 12v6H10z" fill="currentColor" opacity="0.18"/>
    <path d="M10 26l22-12 22 12v6H10z" stroke="currentColor" stroke-width="2.5" stroke-linejoin="round" fill="none"/>
    <line x1="16" y1="32" x2="16" y2="46" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
    <line x1="26" y1="32" x2="26" y2="46" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
    <line x1="38" y1="32" x2="38" y2="46" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
    <line x1="48" y1="32" x2="48" y2="46" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/>
    <rect x="8" y="46" width="48" height="6" rx="2" stroke="currentColor" stroke-width="2.5" fill="currentColor" fill-opacity="0.18"/>
  </svg>`,
  goals: `<svg viewBox="0 0 64 64" fill="none">
    <circle cx="32" cy="32" r="22" fill="currentColor" opacity="0.18"/>
    <circle cx="32" cy="32" r="22" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <circle cx="32" cy="32" r="14" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <circle cx="32" cy="32" r="6" fill="currentColor"/>
  </svg>`,
  income: `<svg viewBox="0 0 64 64" fill="none">
    <rect x="10" y="22" width="44" height="28" rx="4" fill="currentColor" opacity="0.18"/>
    <rect x="10" y="22" width="44" height="28" rx="4" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <circle cx="32" cy="36" r="6" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <path d="M32 8v12M26 14l6-6 6 6" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  </svg>`,
  onboarding: `<svg viewBox="0 0 64 64" fill="none">
    <circle cx="32" cy="32" r="20" fill="currentColor" opacity="0.18"/>
    <circle cx="32" cy="32" r="20" stroke="currentColor" stroke-width="2.5" fill="none"/>
    <path d="M22 32l8 8 14-16" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  </svg>`
};
